...
const variantClasses = computed(() => {
  ...
  const map = {
    ...
    secondary: 'from-gray-500 to-gray-600 group-active:from-gray-600 group-active:to-gray-700 dark:from-gray-600 dark:to-gray-700 dark:group-active:from-gray-700 dark:group-active:to-gray-800',
...
<template>
  <component :is="to ? 'NuxtLink' : 'button'" :to="to" :type="!to ? type : undefined" :disabled="loading"
    ...
    <div class="relative z-10 flex items-center justify-center gap-2 transition-transform duration-150 ease-out"
      ...
      <AppSpinner v-if="loading" size="sm" color="text-current" />
